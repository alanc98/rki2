...
#define CONFIGURE_INIT_TASK_STACK_SIZE	(48*1024)
#define CONFIGURE_INIT_TASK_PRIORITY	120

#define CONFIGURE_MAXIMUM_TASKS                        64 
#define CONFIGURE_MAXIMUM_TIMERS                        5
#define CONFIGURE_MAXIMUM_SEMAPHORES                  256 
...
#define CONFIGURE_EXECUTIVE_RAM_SIZE	( 1 * 512 * 1024 )
...
#define CONFIGURE_BDBUF_CACHE_MEMORY_SIZE (1 * 64 * 1024)
